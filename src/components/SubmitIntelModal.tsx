...
const REPO_OWNER = "cyberdude88";
const REPO_NAME = "osint-siem";
...
export function SubmitIntelModal({ isOpen, onClose }: Props) {
  ...
  const issueBody = [
    ...
    "",
    "---",
    "_Submitted via OSINT SIEM user submission form. Please review and categorize under `private_sector` if appropriate._",
  ].join("\n");
